                    ...
                    @else
                        <form wire:submit.prevent="save" class="space-y-7">
                            <div>
                                ...
                                <div class="space-y-4">
                                    <div>
                                        <x-label for="agency_code">Agency Code *</x-label>
                                        <x-input id="agency_code" wire:model="code" placeholder="e.g. AGY-1001" />
                                        @error('code') <p class="text-xs text-rose-600 dark:text-rose-400 mt-1">{{ $message }}</p> @enderror
                                    </div>

                                    <div>
                                        <x-label for="agency_name">Agency Name *</x-label>
                                        <x-input id="agency_name" wire:model="name" placeholder="e.g. Ministry of Communications" />
                                    ...
                                    <div class="flex items-center gap-3 pt-2">
                                        ...
                                        <x-label for="is_active" class="cursor-pointer mb-0">Active Status</x-label>
                                    </div>
                                </div>
                            </div>
                        </form>
