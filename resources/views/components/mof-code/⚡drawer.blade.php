                    ...
                    @else
                        <form wire:submit.prevent="save" class="space-y-7">
                            <div>
                                ...
                                <div class="space-y-4">
                                    <div>
                                        <x-label for="mof_subcategory_id">MOF Subcategory *</x-label>
                                    ...
                                    <div>
                                        <x-label for="code_val">MOF Code *</x-label>
                                        <x-input id="code_val" wire:model="code" placeholder="e.g. 010101" />
                                        @error('code') <p class="text-xs text-rose-600 dark:text-rose-400 mt-1">{{ $message }}</p> @enderror
                                    </div>

                                    <div>
                                        <x-label for="code_name">Field Description *</x-label>
                                        <x-input id="code_name" wire:model="name" placeholder="e.g. Perabot, Perabot Makmal dan Kelengkapan" />
