                    ...
                    <div class="flex items-center gap-3 min-w-0">
                        ...
                        <div class="min-w-0">
                            <h2 class="text-sm font-semibold text-zinc-900 dark:text-zinc-100 truncate">
                                @if($mode === 'view')
                                    {{ $shortname ?: 'State Details' }}
                                @elseif($mode === 'edit')
                                    Edit — {{ $shortname ?: 'State' }}
                                @else
                                    New State Record
                                @endif
                            </h2>
                            <p class="text-xs text-zinc-500 dark:text-zinc-400 mt-0.5">
                                ...
                                @elseif($mode === 'edit')
                                    Editing state reference data.
                                @else
                                    Create a new state master record.
                                @endif
                            </p>
                        </div>
                    </div>
                        ...
                        <div class="space-y-7">
                            <div>
                                ...
                                <dl class="grid grid-cols-2 gap-x-6 gap-y-4">
                                    <div>
                                        <dt class="text-xs font-semibold uppercase tracking-wider text-zinc-400 dark:text-zinc-500">State Code</dt>
                                        <dd class="mt-1 text-sm font-mono text-zinc-900 dark:text-zinc-100 font-semibold">{{ $code ?: '—' }}</dd>
                                    </div>
                                    <div>
                                        <dt class="text-xs font-semibold uppercase tracking-wider text-zinc-400 dark:text-zinc-500">Capital</dt>
                                        <dd class="mt-1 text-sm text-zinc-900 dark:text-zinc-100 font-medium">{{ $capital ?: '—' }}</dd>
                                    </div>
                                    <div>
                                        <dt class="text-xs font-semibold uppercase tracking-wider text-zinc-400 dark:text-zinc-500">Short Name</dt>
                                        <dd class="mt-1 text-sm text-zinc-900 dark:text-zinc-100 font-semibold">{{ $shortname ?: '—' }}</dd>
                                    </div>
                                    <div>
                                        <dt class="text-xs font-semibold uppercase tracking-wider text-zinc-400 dark:text-zinc-500">Full Name</dt>
                                        <dd class="mt-1 text-sm text-zinc-900 dark:text-zinc-100 font-semibold">{{ $fullname ?: '—' }}</dd>
                                    </div>
                                </dl>
                            </div>
                        </div>
