                    ...
                    <div class="flex items-center gap-3 min-w-0">
                        ...
                        <div class="min-w-0">
                            ...
                            <p class="text-xs text-zinc-500 dark:text-zinc-400 mt-0.5">
                                ...
                                @elseif($mode === 'edit')
                                    Editing agency master record.
                                @else
                                    Create a new government agency or ministry.
                                @endif
                            </p>
                        </div>
                    </div>
                        ...
                        <div class="space-y-7">
                            <div>
                                ...
                                <dl class="grid grid-cols-2 gap-x-6 gap-y-4">
                                    <div>
                                        <dt class="text-xs font-semibold uppercase tracking-wider text-zinc-400 dark:text-zinc-500">Agency Code</dt>
                                    ...
                                    <div class="col-span-2">
                                        <dt class="text-xs font-semibold uppercase tracking-wider text-zinc-400 dark:text-zinc-500">Agency Name</dt>
