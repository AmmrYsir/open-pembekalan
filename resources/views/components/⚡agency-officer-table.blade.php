...
<div class="space-y-6">
    ...
    <x-card>
        <div class="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4 mb-6">
            ...
            <x-button variant="primary" size="sm" @click="$dispatch('open-agency-officer-drawer', { mode: 'create' })">
        ...
        <x-table :headers="['Officer Account', 'Position', 'Agency / Subagency', 'Verification Status', 'Actions']">
            @forelse($this->officers as $officer)
                <tr class="hover:bg-zinc-50/60 dark:hover:bg-zinc-800/20 transition-colors">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        ...
                        @else
                            <x-badge variant="warning" pill>Unverified</x-badge>
                        @endif
                    </td>
