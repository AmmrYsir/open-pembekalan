            ...
            @forelse($this->officers as $officer)
                <tr class="hover:bg-zinc-50/60 dark:hover:bg-zinc-800/20 transition-colors">
                    <td class="px-6 py-4 whitespace-nowrap">
                        <div class="font-semibold text-zinc-900 dark:text-zinc-100 text-sm">{{ $officer->user?->name ?? 'Focal Officer' }}</div>
                        <div class="text-xs text-zinc-500 font-mono mt-0.5">{{ $officer->user?->email ?? '-' }}</div>
                    </td>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        ...
                        @else
                            <x-ui.badge variant="warning" pill>Unverified</x-ui.badge>
                        @endif
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-right">
                        <div class="flex items-center justify-end gap-1">
                            <button
                                wire:click="$dispatch('open-agency-officer-drawer', { mode: 'view', id: {{ $officer->id }} })"
                                title="View"
                            ...
                            <button
                                wire:click="$dispatch('open-agency-officer-drawer', { mode: 'edit', id: {{ $officer->id }} })"
                                title="Edit"
                            ...
                            <button
                                wire:click="confirmDelete({{ $officer->id }})"
                                title="Delete"
                ...
                <tr>
                    <td colspan="5" class="px-5 py-16 text-center">
                        <div class="flex flex-col items-center gap-3">
                            ...
                            <div>
                                <p class="text-sm font-semibold text-zinc-700 dark:text-zinc-300">No agency officers found</p>
    ...
    >
        ...
        >
            <div class="flex items-start gap-4">
                ...
                <div>
                    <h3 class="text-sm font-semibold text-zinc-900 dark:text-zinc-100">Delete Officer Account</h3>
                    <p class="text-xs text-zinc-550 dark:text-zinc-400 mt-1">Are you sure you want to delete this agency officer account?</p>
                </div>
            </div>
