        ...
        <x-ui.table :headers="['Agency Code', 'Agency Name', 'Subagencies', 'Status', 'Actions']">
            @forelse($this->agencies as $agency)
                <tr class="hover:bg-zinc-50/60 dark:hover:bg-zinc-800/20 transition-colors">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-zinc-900 dark:text-zinc-100 font-semibold text-sm">
                        {{ $agency->name }}
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
                        <x-ui.badge variant="info" pill>{{ $agency->subagencies_count }} Subagencies</x-ui.badge>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
                        <x-ui.badge variant="{{ $agency->is_active ? 'success' : 'secondary' }}" pill>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-right">
                        <div class="flex items-center justify-end gap-1">
                            <button
                                wire:click="$dispatch('open-agency-drawer', { mode: 'view', id: {{ $agency->id }} })"
                                title="View"
                            ...
                            <button
                                wire:click="$dispatch('open-agency-drawer', { mode: 'edit', id: {{ $agency->id }} })"
                                title="Edit"
                            ...
                            <button
                                wire:click="confirmDelete({{ $agency->id }})"
                                title="Delete"
                ...
                <tr>
                    <td colspan="5" class="px-5 py-16 text-center">
                        <div class="flex flex-col items-center gap-3">
                            ...
                            <div>
                                <p class="text-sm font-semibold text-zinc-700 dark:text-zinc-300">No agencies found</p>
    ...
    >
        ...
        >
            <div class="flex items-start gap-4">
                ...
                <div>
                    <h3 class="text-sm font-semibold text-zinc-900 dark:text-zinc-100">Delete Agency</h3>
                    <p class="text-xs text-zinc-550 dark:text-zinc-400 mt-1">Are you sure you want to delete this agency?</p>
                </div>
            </div>
