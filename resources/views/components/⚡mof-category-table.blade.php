...
<div class="space-y-6">
    ...
    <x-card>
        <div class="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4 mb-6">
            ...
            <x-button variant="primary" size="sm" @click="$dispatch('open-mof-category-drawer', { mode: 'create' })">
                <x-heroicon-o-plus class="w-4 h-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" />
                Add MOF Category
            </x-button>
        </div>

        <x-table :headers="['Category Code', 'Category Name', 'Subcategories', 'Actions']">
            @forelse($this->categories as $category)
                <tr class="hover:bg-zinc-50/60 dark:hover:bg-zinc-800/20 transition-colors">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        <x-badge variant="info" pill>{{ $category->subcategories_count }} Subcategories</x-badge>
                    </td>
