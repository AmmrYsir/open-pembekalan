        ...
        <x-ui.table :headers="['State Code', 'Short Name', 'Full Name', 'Capital', 'Actions']">
            @forelse($this->states as $st)
                <tr class="hover:bg-zinc-50/60 dark:hover:bg-zinc-800/20 transition-colors">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap font-medium text-zinc-900 dark:text-zinc-100 text-sm">
                        {{ $st->shortname }}
                    </td>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-right">
                        <div class="flex items-center justify-end gap-1">
                            <button
                                wire:click="$dispatch('open-state-drawer', { mode: 'view', id: {{ $st->id }} })"
                                title="View"
                            ...
                            <button
                                wire:click="$dispatch('open-state-drawer', { mode: 'edit', id: {{ $st->id }} })"
                                title="Edit"
                ...
                <tr>
                    <td colspan="5" class="px-5 py-16 text-center">
                        <div class="flex flex-col items-center gap-3">
                            ...
                            <div>
                                <p class="text-sm font-semibold text-zinc-700 dark:text-zinc-300">No states found</p>
    ...
    >
        ...
        >
            <div class="flex items-start gap-4">
                ...
                <div>
                    <h3 class="text-sm font-semibold text-zinc-900 dark:text-zinc-100">Delete State</h3>
                    <p class="text-xs text-zinc-550 dark:text-zinc-400 mt-1">Are you sure you want to delete this state?</p>
                </div>
            </div>
