        ...
        <x-ui.table :headers="['Subagency Code', 'Subagency Name', 'Parent Agency', 'Status', 'Actions']">
            @forelse($this->subagencies as $subagency)
                <tr class="hover:bg-zinc-50/60 dark:hover:bg-zinc-800/20 transition-colors">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-zinc-650 dark:text-zinc-300 text-sm">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-right">
                        <div class="flex items-center justify-end gap-1">
                            <button
                                wire:click="$dispatch('open-subagency-drawer', { mode: 'view', id: {{ $subagency->id }} })"
                                title="View"
                            ...
                            <button
                                wire:click="$dispatch('open-subagency-drawer', { mode: 'edit', id: {{ $subagency->id }} })"
                                title="Edit"
                            ...
                            <button
                                wire:click="confirmDelete({{ $subagency->id }})"
                                title="Delete"
                ...
                <tr>
                    <td colspan="5" class="px-5 py-16 text-center">
                        <div class="flex flex-col items-center gap-3">
                            ...
                            <div>
                                <p class="text-sm font-semibold text-zinc-700 dark:text-zinc-300">No subagencies found</p>
    ...
    >
        ...
        >
            <div class="flex items-start gap-4">
                ...
                <div>
                    <h3 class="text-sm font-semibold text-zinc-900 dark:text-zinc-100">Delete Subagency</h3>
                    <p class="text-xs text-zinc-550 dark:text-zinc-400 mt-1">Are you sure you want to delete this subagency?</p>
                </div>
            </div>
