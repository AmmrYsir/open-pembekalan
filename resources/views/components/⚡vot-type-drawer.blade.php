                    ...
                    <div class="flex items-center gap-3 min-w-0">
                        ...
                        <div class="min-w-0">
                            ...
                            <p class="text-xs text-zinc-500 dark:text-zinc-400 mt-0.5">
                                ...
                                @elseif($mode === 'edit')
                                    Editing budget vot account classification.
                                @else
                                    Create a new budget vot code.
                                @endif
                            </p>
                        </div>
                    </div>
                        ...
                        <div class="space-y-7">
                            <div>
                                ...
                                <dl class="grid grid-cols-2 gap-x-6 gap-y-4">
                                    <div>
                                        <dt class="text-xs font-semibold uppercase tracking-wider text-zinc-400 dark:text-zinc-500">Vot Code</dt>
                                        <dd class="mt-1 text-sm font-mono text-emerald-700 dark:text-emerald-400 font-bold">{{ $code ?: '—' }}</dd>
                                    </div>
                                    <div class="col-span-2">
                                        <dt class="text-xs font-semibold uppercase tracking-wider text-zinc-400 dark:text-zinc-500">Description / Account Name</dt>
