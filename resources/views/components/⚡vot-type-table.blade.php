                ...
                <tr class="hover:bg-zinc-50/60 dark:hover:bg-zinc-800/20 transition-colors">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-right">
                        <div class="flex items-center justify-end gap-1">
                            <button
                                wire:click="$dispatch('open-vot-type-drawer', { mode: 'view', id: {{ $vot->id }} })"
                                title="View"
                            ...
                            <button
                                wire:click="$dispatch('open-vot-type-drawer', { mode: 'edit', id: {{ $vot->id }} })"
                                title="Edit"
                            ...
                            <button
                                wire:click="confirmDelete({{ $vot->id }})"
                                title="Delete"
                ...
                <tr>
                    <td colspan="3" class="px-5 py-16 text-center">
                        <div class="flex flex-col items-center gap-3">
                            ...
                            <div>
                                <p class="text-sm font-semibold text-zinc-700 dark:text-zinc-300">No vot types found</p>
    ...
    >
        ...
        >
            <div class="flex items-start gap-4">
                ...
                <div>
                    <h3 class="text-sm font-semibold text-zinc-900 dark:text-zinc-100">Delete Vot Type</h3>
                    <p class="text-xs text-zinc-550 dark:text-zinc-400 mt-1">Are you sure you want to delete this vot type?</p>
                </div>
            </div>
